...
#
# DESCRIPTION
#   Here all the different elements are put together to show how the CIF classes and functions can work together.
...
if __name__ == "__main__":
    ...
    inputNetStruc = networkGenerator.createNetLayer(xN=2, groupId=0)

    # Main layer/body-of-neurons: a large grid of neurons
    mainNetStruc = networkGenerator.createNetLayer(xN=8, yN=8, groupId=1)
    ...
    inputToMainConnProb = networkGenerator.createConnectionProb(inputNetStruc, mainNetStruc, layerConnProbFunc)
    ...
    mainToMainConnProb = networkGenerator.createConnectionProb(mainNetStruc, mainNetStruc, bodyConnProbFunc )

    # Define connection from main-body to main-body
    mainToMainConnections = networkGenerator.createConnectionArray(mainToMainConnProb, groupId1=1, groupId2=1)
    ...
    inputArray = analogToSpikes.multiPoissonStreams(2, startTime=0.0, stopTime=100.0, rateBounds=[20., 40.], intervalBounds=[2., 8.])
    print(inputArray)
    ...
    simResultsList = demo_SingleLayerSimulation.singleLayerSimulationNewAdapt(inputNetStruc, mainNetStruc, inputToMainConnections,
    ...
    simResultsList = demo_SingleLayerSimulation.singleLayerSimulationNew(inputNetStruc, mainNetStruc,
    ...
    myFilterMan = cifManager.condItenFuncManager(.001)  # We have to give it the dt we are using
