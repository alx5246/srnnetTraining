...
FILES AND FOLDERS
    ...
    (1) decompDimensions.py
        ...
        siggle DOF into multi overlapping fields where each field represents a neuron.

    (2) analogToSpikes.py
        This python module/file has methods that take in time-varying rates and produces spike-trains.
